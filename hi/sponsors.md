    ...
    <div class="card border-0 shadow-sm">
      <div class="card-body p-4 p-md-5">
        ...
        <div class="row g-4 mb-4">
          <div class="col-md-6">
            <h3 class="h6 text-primary">निर्णय निर्माताओं तक पहुंचें</h3>
          ...
          <div class="col-md-6">
            ...
            <p class="small mb-0">अपने संगठन को कंप्यूटिंग शिक्षा के चैंपियन के रूप में स्थापित करें। कार्यक्रम सामग्री, वेबसाइट और संचार में लोगो दृश्यता।</p>
          </div>
          <div class="col-md-6">
